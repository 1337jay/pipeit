...
const TETROMINOES = [
  ...
  { shape: [[1,0,0],[1,1,1]], width: 3, height: 2 }, // J
  { shape: [[0,0,1],[1,1,1]], width: 3, height: 2 }, // L
  { shape: [[1,1],[1,1]], width: 2, height: 2 }, // O
  { shape: [[0,1,1],[1,1,0]], width: 3, height: 2 }, // S
  { shape: [[0,1,0],[1,1,1]], width: 3, height: 2 }, // T
  { shape: [[1,1,0],[0,1,1]], width: 3, height: 2 }, // Z
];
