...
const benefits = [
    ...
    },
    {
        ...
        description: 'Type-safe builder with compile-time validation prevents incomplete transactions from reaching the network.',
        icon: IconXmarkCircleFill,
    },
    {
        name: 'Zero Manual Configuration',
        description: 'Automatic blockhash fetching, lifetime tracking, and transaction lifecycle management with durable nonce support.',
        icon: IconXmarkCircleFill,
    },
    {
    ...
    },
    {
        ...
        description: 'Pre-flight simulation catches errors early to reduce failed transactions and save on network fees.',
        icon: IconXmarkCircleFill,
    },
    {
        name: 'Optimize Transaction Costs',
        description: 'Simple priority fee presets and automatic compute unit optimization prevent transaction failures.',
        icon: IconXmarkCircleFill,
    },
    {
        name: 'Extend & Customize',
        description: 'Composable middleware system for logging, monitoring, retry, and simulation with reusable components.',
        icon: IconXmarkCircleFill,
    },
    {
        name: 'No Transaction Size Limits',
        description: 'Automatically detects and splits oversized transactions to eliminate "transaction too large" errors.',
        icon: IconXmarkCircleFill,
    },
    {
        name: 'Guarantee Execution Order',
        description: 'Atomic grouping ensures instructions execute together or not at all for critical DeFi operations.',
        icon: IconXmarkCircleFill,
    },
];
